...
public class HttpProxy {
	...
	private static final String CONNECT_TYPE_JSON = "application/json";
	...
	public static String postJson(String requestUrl, String jsonContent) throws IOException{
		...
		requestEntity.setContentType(CONNECT_TYPE_JSON);
		return execute(requestUrl,requestEntity);
	 ...
	 */
	private static String execute(String requestUrl, HttpEntity httpEntity) throws ClientProtocolException, IOException{
		String result = null;
		HttpPost httpPost = new HttpPost(requestUrl);
